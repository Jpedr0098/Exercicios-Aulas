...
var ContaCorrente = /** @class */ (function (_super) {
    ...
    ContaCorrente.prototype.exibirSaldo = function () {
        ...
        return "".concat(_super.prototype.exibirSaldo.call(this), ", Saldo Toptal com Cr\u00E9dito: R$").concat(saldoTotal.toFixed(2));
    };
    return ContaCorrente;
}(ContaBancaria));
var contaCorrenteExemplo = new ContaCorrente('Jessica', 7500, 2000);
